from model.AttenModel.AttenUnet_Boundary import Mymodel
from model.UnetModel.Unet_Boundary import Mymodel
...
def train(epoch):
    ...
    for batch_idx, (inputs, lungs, medias, targets_u, targets_i, targets_s) in enumerate(dataloader):
        ...
        loss_all = config.weight_seg1 * loss_seg_final + config.weight_seg2 * (loss_seg_i + loss_seg_u + loss_seg_s) + config.weight_edge * loss_edge
