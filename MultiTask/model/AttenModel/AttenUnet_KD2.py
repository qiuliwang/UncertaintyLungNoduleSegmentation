...
class Mymodel(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        ...
        # Channel Alignment
        self.conv_channel1_1 = conv_block(ch_in=256, ch_out=64)
        self.conv_channel1_2 = single_conv(ch_in=64, ch_out=3)
        self.conv_channel2_1 = conv_block(ch_in=64, ch_out=32)
        self.conv_channel2_2 = single_conv(ch_in=32, ch_out=3)
    ...
    def forward(self,x,flag=False):
        ...
        if flag:
            # upsampling feature
            feature1 = F.interpolate(d4, size=(64,64), mode='bilinear', align_corners=True)
            feature1 = self.conv_channel1_1(feature1)
            feature1 = self.conv_channel1_2(feature1)
            feature2 = F.interpolate(d2, size=(64,64), mode='bilinear', align_corners=True)
            feature2 = self.conv_channel2_1(feature2)
            feature2 = self.conv_channel2_2(feature2)

            return [x1, x2, x3, x4, x5], [feature1, feature2]
